...
=======
                    <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseIRS" aria-expanded="true" aria-controls="collapseIRS">
                        IRS (Rencana Studi)
                    </button>
                </h2>
                <div id="collapseIRS" class="accordion-collapse collapse show" aria-labelledby="headingIRS" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                        <!--  IRS -->
                        <div class="accordion-header">
...
=======
                ...
                <div id="collapseKHS" class="accordion-collapse collapse" aria-labelledby="headingKHS" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                        <!-- Isi KHS -->
                        <div class="accordion-header">
                                <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseKHS1" aria-expanded="false" aria-controls="collapseIRS1">
                                    Semester 1
                                </button>
                            </div>
                            <div id="collapseKHS1" class="accordion-collapse collapse" data-bs-parent="#accordion">
                            ...
                            <div class="accordion-header">
                                <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseKHS2" aria-expanded="false" aria-controls="collapseKHS2">
                                    Semester 2
                                </button>
                            </div>
                            <div id="collapseKHS2" class="accordion-collapse collapse" data-bs-parent="#accordion">
                            ...
                            <div class="accordion-header">
                                <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseKHS3" aria-expanded="false" aria-controls="collapseKHS3">
                                    Semester 3
                                </button>
                            </div>
                            <div id="collapseKHS3" class="accordion-collapse collapse" data-bs-parent="#accordion">
                            ...
                            <div class="accordion-header">
                                <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseKHS4" aria-expanded="false" aria-controls="collapseKHS4">
                                    Semester 4
                                </button>
                            </div>
                            <div id="collapseKHS4" class="accordion-collapse collapse" data-bs-parent="#accordion">
                            ...
                            <div class="accordion-header">
                                <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseKHS5" aria-expanded="false" aria-controls="collapseKHS5">
                                    Semester 5
                                </button>
                            </div>
                            <div id="collapseKHS5" class="accordion-collapse collapse" data-bs-parent="#accordion">
...
=======
                ...
                <div id="collapseTranskrip" class="accordion-collapse collapse" aria-labelledby="headingTranskrip" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                        <!-- Isi Transkrip -->
                        <p>Berikut adalah transkrip nilai akhir mahasiswa yang mencakup nilai akhir dari seluruh mata kuliah yang diambil.</p>
                        <a href="#" class="btn btn-fill">Download Transkip</a>
